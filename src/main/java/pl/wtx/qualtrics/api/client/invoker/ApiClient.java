...
import pl.wtx.qualtrics.api.client.invoker.auth.Authentication;
import pl.wtx.qualtrics.api.client.invoker.auth.HttpBasicAuth;
import pl.wtx.qualtrics.api.client.invoker.auth.HttpBearerAuth;
import pl.wtx.qualtrics.api.client.invoker.auth.ApiKeyAuth;
import pl.wtx.qualtrics.api.client.invoker.auth.OAuth;
import pl.wtx.qualtrics.api.client.invoker.auth.RetryingOAuth;
import pl.wtx.qualtrics.api.client.invoker.auth.OAuthFlow;
...
public class ApiClient {
    ...
    private String basePath = "https://yul1.qualtrics.com/API/v3";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://yul1.qualtrics.com/API/v3",
      "Canadian Data Center",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "https://iad1.qualtrics.com/API/v3",
      "Washington, DC Area Data Center (previously CO1)",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
    ...
    new ServerConfiguration(
      ...
      "European Union Data Center (previously EU2 or EU)",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "https://lhr1.qualtrics.com/API/v3",
      "London, United Kingdom Data Center",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "https://syd1.qualtrics.com/API/v3",
      "Sydney, Australia Data Center (previously AU1)",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "https://sin1.qualtrics.com/API/v3",
      "Singapore Data Center",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "https://hnd1.qualtrics.com/API/v3",
      "Tokyo, Japan Data Center",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "https://gov1.qualtrics.com/API/v3",
      "US Government Data Center",
      new HashMap<String, ServerVariable>()
    )
  ));
    ...
    public ApiClient() {
        ...
        authentications.put("api_token", new ApiKeyAuth("header", "X-API-TOKEN"));
        authentications.put("public_oauth2", new OAuth());
        authentications.put("public_oauth2", new OAuth());
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "https://ca1.qualtrics.com/oauth2/token";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://yul1.qualtrics.com/API/v3
     ...
     * @return a {@link pl.wtx.qualtrics.api.client.invoker.ApiClient} object
     */
    ...
    */
     ...
     * @throws pl.wtx.qualtrics.api.client.invoker.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws pl.wtx.qualtrics.api.client.invoker.ApiException If fail to serialize the given object
     */
     ...
     * @throws pl.wtx.qualtrics.api.client.invoker.ApiException If fail to read file content from response and write to disk
     ...
     * @throws pl.wtx.qualtrics.api.client.invoker.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws pl.wtx.qualtrics.api.client.invoker.ApiException If the response has an unsuccessful status code or
     ...
     * @throws pl.wtx.qualtrics.api.client.invoker.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws pl.wtx.qualtrics.api.client.invoker.ApiException If fails to update the parameters
     */
     ...
     * @throws pl.wtx.qualtrics.api.client.invoker.ApiException If fail to serialize the request body object into a string
     */
