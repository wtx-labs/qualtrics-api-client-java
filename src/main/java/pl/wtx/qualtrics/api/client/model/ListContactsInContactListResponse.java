...
public class ListContactsInContactListResponse {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListContactsInContactListResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ListContactsInContactListResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListContactsInContactListResponse.openapiRequiredFields) {
      ...
      Result16.validateJsonElement(jsonObj.get("result"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListContactsInContactListResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListContactsInContactListResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListContactsInContactListResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListContactsInContactListResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListContactsInContactListResponse>() {
           @Override
           public void write(JsonWriter out, ListContactsInContactListResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListContactsInContactListResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListContactsInContactListResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListContactsInContactListResponse
   * @throws IOException if the JSON string is invalid with respect to ListContactsInContactListResponse
   */
  public static ListContactsInContactListResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListContactsInContactListResponse.class);
  }

  /**
   * Convert an instance of ListContactsInContactListResponse to an JSON string
   *
   * @return JSON string
   */
